  ...
  $effect(() => {
    ...
    const mountTerminal = async () => {
      ...
      terminal = new Terminal({
        ...
        letterSpacing: 0.2,
        theme: {
          background: readThemeToken('--ctp-mocha-base'),
          foreground: readThemeToken('--ctp-mocha-text'),
          cursor: readThemeToken('--ctp-mocha-rosewater'),
          cursorAccent: readThemeToken('--ctp-mocha-crust'),
