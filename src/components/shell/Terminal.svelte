...
<!-- Terminal chrome styles live in global.css (.term*) — Astro drops a nested runtime
     island child's scoped CSS under inlineStylesheets:'always', so a component <style>
     block here would not ship to production. -->
